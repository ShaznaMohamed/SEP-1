...
<div id="container">
    ...
    <main>
        <div class="centre">
            ...
            <div id="slideshow">
                <div class="slider">
                    <div class="item"><img alt="" src="/images/meetings.png" width="400" height="400" /></div>
                </div>
                <div class="nav">
                ...
                <div class="featurelist">
                    <table>
                        <tr>
                            <td>
                    <div class="feature">
                        <img alt="" src="/images/meetings.png" width="200" height="300" class="thumb" />
                        <div class="details">
        ...
        <div class="centre">
            ...
            <div id="specials" class="list">
                <div class="back">
                    <div class="slider">
                        <div class="item">
                            <img alt="" src="/images/events.jpg" width="1200" height="400" />
                            <div class="details">
