    ...
    <main>
        <div class="centre">
            <div id="left">
                <article>
                    <div class="main">
                        <div class="img"><a href="{{url('gallery')}}"><img alt="" src="images/roomimages/room1.jpg" width="770" height="500" /></a></div>
            ...
            <?php $tabledata = DB::table('room')->where('roomtype', 'royal')->get(); ?>
            <?php
