                        ...
                        <h1>MAKE A REQUEST</h1>
                            <form name="form1" id="form1" class="form-vertical" role="form" method="post" action="{{route('events')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="field select">
                                        <select type="text" name="venue" class="form-control" id="venue" value="">
                                ...
                                <div class="form-group">
                                    <label for="pax" class="control-label">No of Pax* :</label>
                                    <input type="text" name="pax" class="form-control" id="pax" value="">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contact_number" class="form-control" id="contact_number" value="">
                                </div>

                                <div class="form-group">
                                    <label for="type_of_event" class="control-label">Type of Event* :</label>
                                    <input type="text" name="type_of_event" class="form-control" id="type_of_event" value="">
                                </div>

                                <div class="form-group">
                                    <label for="preferred_time" class="control-label"><b>Preferred time to receive call :</b></label>
                                    <input type="text" name="preferred_time" class="form-control" id="preferred_time" value="">
                                </div>
