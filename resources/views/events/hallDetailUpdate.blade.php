...
<body style="font-family: 'Open Sans';">
  <div id="pop" class="popform">
    <div class="container">
      ...
      <form role="form" method="POST" action="{{ url('hallDetailUpdate') }}">
        {!! csrf_field() !!}
        <div class="col"></div>
        <div class="col">
          <div class="field"><input type="text" class="form-control" name="topic" value="{{ $user->topic }}" required="true"></div>
          <div class="field"><input type="text" class="form-control" name="value" value="{{ $user->value }}" required="true"></div>
