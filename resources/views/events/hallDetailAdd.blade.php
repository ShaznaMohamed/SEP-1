...
<body style="font-family: 'Open Sans';">
  <div id="pop" class="popform">
    <div class="container">
      ...
      <form role="form" method="POST" action="{{ url('hallDetailAdd') }}">
        {!! csrf_field() !!}
        <div class="col"></div>
        <div class="col">
          <div class="field"><input type="text" class="form-control" name="topic" placeholder="Topic Name" required="true"></div>
          <div class="field"><input type="text" class="form-control" name="value" placeholder="Value" required="true"></div>
