    ...
    <main>
        <div class="centre">
            ...
            <section id="rooms" class="list">
                <div class="item">
                    <div class="imgcontainer"><img alt="" src=/wedimages/poolside.jpg  width="1200" height="400" /></div>
                    <div class="details">
            ...
            <!-- Video | START -->
            <div id="video">
                <div class="imgcontainer"><img alt="" src="/wedimages/wedd.jpg" width="1150" height="575" > </div>
            </div>
            <!-- Video | END -->
        </div>
    </main>
