    ...
    <main>
        <div class="centre">
            ...
            <div id="contact">
                ...
                <form action="{{route('room')}}" role="form" method="post" novalidate>
                    ...
                    <div class="col">
                        ...
                        <div class="field"><input name="noofrooms" type="text" placeholder="Number of Rooms" id="contact-pax" /></div>
                        <div class="select">
                            <select name="adult" id="contact-rrooms" class="infants">
                                <option value="1 Adult" selected="selected">1 Adult</option>
                    ...
                    <div class="col">
                        ...
                        <div class="field"><select name="children" id="contact-adults" class="adults">
                                <option value="1 Child" selected="selected">1 Child</option>
                    ...
                    <button>
                        ...
                        <span data-hover="Send Booking Request"></span></button></input>
