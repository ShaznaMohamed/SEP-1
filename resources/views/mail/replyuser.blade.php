...
<div id="pop" class="popform">
    <div class="container">
        ...
        <form role="form" method="POST" action="{{ route('reply')}}">
          <div class="field"><input type="text" class="form-control" name="name" required placeholder="Name" value="{{ $msg->name }}"></div>
          <div class="field"><input type="email" class="form-control" name="email" required placeholder="E-mail" value="{{ $msg->email }}"></div>
          <div class="field"><input type="text" class="form-control" name="subject" required placeholder="Subject" value="{{ $msg->subject }}"></div>
