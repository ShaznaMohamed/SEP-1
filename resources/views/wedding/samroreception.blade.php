...
@section('maincontent')
    ...
    <main>
        <div class="centre">
            ...
            <section id="rooms" class="list">
                <div class="item">
                    <div class="imgcontainer"><img alt="" src=images/wedimages/samro.jpg  width="1200" height="400" /></div>
                    <div class="details">
                        <a href="{{url('weddingplanner')}}">
                            <h3 class="title">Samro Reception<br />
                                <span>Stay with 150-300 guests</span></h3><br>
                            <p>Get inside the glittering cave full of tumbling golden drops. Host your nuptials at Samro for a fairytale beginning to your new life.</p>
            ...
            <div id="content">
                <h2><strong>Find Samro</strong> with marvelous experiences</h2>
                <p>Make your dream come true at Amalya. Begin your new episode with us. It's the time to make the rest be the best. Feel the magic a little closer to your heart at Samro.
                Enjoy the magical miracle of your big day celebrations. Let Amalya bid the love of you and your spouce for a last long enrichment. Gather with all your invitees at Samro. We are always ready to provide irreplacable backdrops of paradise.</p>
    ...
    <!--end of retrieved sevices showing-->
            ...
            <!-- Video | START -->
            <div id="video">
                <div class="imgcontainer"><img src="images/wedimages/vb.jpg" width="1200" height="600"></div>
            </div>
            <!-- Video | END -->
        </div>
    </main>
