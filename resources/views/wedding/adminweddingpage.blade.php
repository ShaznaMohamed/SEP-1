...
@section('maincontent')
  <header>
    <div id="header">
      <div class="h1">
        <h1><span>Wedding Hall Features</span>
        </div>
      </div>
    </header>
        ...
        <table>
          ...
          <tbody>
            ...
            foreach ($tabledata as $row) {
              ?>
              <tr>
                <td><?php echo $row->halltype;
                ?></td>
                <td><?php echo $row->advancepayment;
                ?></td>
                <td><?php echo $row->minimumpax;
                ?></td>
                <td><?php echo $row->additionalhour;
                ?></td>
                <td><?php echo $row->fullpayment;
                ?></td>
                <td><?php echo $row->corkage;
                ?></td>
                <td><?php echo $row->beerlocal;
                ?></td>
                <td><?php echo $row->icedcoffee;
                ?></td>
                <td><?php echo $row->cutlery;
                ?></td>
              </tr>
              <?php
