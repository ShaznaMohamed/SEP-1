    ...
    <main>
        <div class="centre">
            ...
            <div id="contact">
                ...
                <img src=/wedimages/wed3.jpg width="1200" height="400" alt="" />
                <form action="{{route('weddingquotationform')}}" role="form" method="post" novalidate>

                    <!--<div class="col">-->
                        <h3>Wedding Plan</h3><hr>

                        <div class="form-group {{ $errors->has('eventdate') ? ' has-error' : ''}}">
                            <div class="field calendar"><input name="eventdate" type="text" placeholder="Event Date*" id="eventdate" readonly /><i class="fa fa-calendar-o"></i></div>
                 ...
                 <!--   </div>
                    ...
                    <div class="col">-->
                        ...
                        <div class="form-group{{ $errors->has('noofrooms') ? ' has-error' : ''}}">
                            <div class="field"><input name="noofrooms" type="text" placeholder="Number of Guest Rooms" id="pax" /></div>
                   ...
                   <!-- </div>
                    ...
                    <div class="col">-->
                        ...
                        <div class="form-group{{ $errors->has('firstname') ? ' has-error' : ''}}">
                            <div class="field"><input name="firstname" type="text" placeholder="First Name*" id="contact-email" /></div>
                            @if ($errors->has('firstname')) <span class="help-block">{{ $errors->first('firstname') }}</span> @endif
                        </div>

                        <div class="form-group{{ $errors->has('lastname') ? ' has-error' : ''}}">
                            <div class="field"><input name="lastname" type="text" placeholder="Last Name*" id="contact-email" /></div>
                        ...
                        <div class="form-group{{ $errors->has('message') ? ' has-error' : ''}}">
                            <div class="field"><textarea name="message" placeholder="Additional Information" id="contact-message"></textarea></div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="form-group">
                                    <h4><input type="submit" name="sub" value="Send Request" class="btn btn-default"  >
                                        <span data-hover="Add"></span></h4>
                                </div>
                            </td>
                        </tr>
