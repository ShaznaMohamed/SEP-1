    ...
    <main>
        <div class="centre">
            ...
            <section id="rooms" class="list">
                <div class="item">
                    <div class="imgcontainer"><img alt="" src="/images/wedimages/grand.jpg"  width="1200" height="400" /></div>
                    <div class="details">
            ...
            <div id="content">
                ...
                <?php $tabledata = DB::table('weddingservices')->where('halltype', 'grand')->get(); ?>
                <table>
                    <?php
            ...
            <!-- Video | START -->
            <div id="video">
                <div class="imgcontainer"><img alt="" src="images/wedimages/granddd.jpg" width="1150" height="575" > </div>
            </div>
            <!-- Video | END -->
        </div>
    </main>
