    ...
    <main>
        <div class="centre">
            ...
            <section id="rooms" class="list">
                <div class="item">
                    <div class="imgcontainer"><img alt="" src=/wedimages/sil.jpg  width="1200" height="400" /></div>
                    <div class="details">
            ...
            <!-- Video | START -->
            <div id="video">
                <div class="imgcontainer"><img alt="" src="/wedimages/grandd.jpg" width="1200" height="800" > </div>
            </div>
            <!-- Video | END -->
        </div>
    </main>
