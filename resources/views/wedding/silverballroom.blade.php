...
@section('maincontent')
    ...
    <header>
        <div id="header">
            <div class="h1">
                <h1><span>Silver Ball room</span>
                    <span class="tagline">Shinning Chamber</span></h1>
            </div>
        </div>
    ...
    <main>
        <div class="centre">
            ...
            <section id="rooms" class="list">
                <div class="item">
                    <div class="imgcontainer"><img alt="" src="/images/wedimages/sil.jpg" width="1200" height="400" /></div>
                    <div class="details">
                        <a href="{{url('weddingplanner')}}">
                            <h3 class="title">Silver Ball Room<br />
                                <span>Stay with 150-300 guests</span></h3><br>
                            <p>Shinning ball with neon rays scattering from the cascade of silver light beam. It's the time to live your dream with your besties.</p>
            ...
            <div id="content">
                <h2>Tie the knot with <strong>Amalya </strong></h2>
                <p>Make your dream come true. Begin your new episode with us. It's the time to make the rest be the best. Feel the magic a little closer to your heart at Silver Ball Room.
                    Enjoy the magical miracle of your big day celebrations. Let Amalya bid the love of you and your spouce for a last long enrichment. Gather with all your invitees at Amalya. We are always ready to provide irreplacable backdrops of paradise.</p>
                <!--Start of retrieved services showings-->
                <?php $tabledata = DB::table('weddingservices')->where('halltype', 'silver')->get(); ?>
                <table>
                    <?php
            ...
            <!-- Video | START -->
            <div id="video">
                <div class="imgcontainer"><img alt="" src="/images/wedimages/grandd.jpg" width="1200" height="800" > </div>
            </div>
            <!-- Video | END -->
        </div>
    </main>
