...
*
*
This controller is responsible for the genrating reports on room reservations and wedding reservations.
It also can sort them using reserve id, date or the cost. It can also get the reports printed or
generate pdfs.
*/
